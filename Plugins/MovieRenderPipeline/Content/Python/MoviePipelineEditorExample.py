...
def RenderQueue_ViaDuplication():
    ...
    global SubsystemExecutor
    SubsystemExecutor = unreal.MoviePipelinePIEExecutor(subsystem)
    ...
    SubsystemExecutor.on_individual_shot_work_finished_delegate.add_callable_unique(OnIndividualShotFinishedCallback) # Only available on PIE executor
